...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="source/index2.html" class="logo">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="source/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="source/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li><a href="source/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ul class="timeline">
            <!-- timeline time label -->
            <c:forEach items="${syslogList }" var="syslog" varStatus="i">
	            <li class="time-label">
	                  <span class="bg-red">
	                    ${syslog.time }
	                  </span>
	            ...
	            <li>
	              ...
	              <div class="timeline-item">
	                ...
	                <h3 class="timeline-header"><a href="#">${syslog.source }</a>${syslog.title }</h3>
